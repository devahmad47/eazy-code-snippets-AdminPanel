            ...
            <div className="flex flex-inline justify-between items-center">
                <div className="flex justify-start items-center">
                    ...
                    <Link to="/Admin/starter" className="flex items-center justify-between mr-4">
                        {/* <img src={"/books.png"} className="mr-3 h-8" alt="Gravity Logo" /> */}
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">
                            Fa Smart Admin Panel
                        </span>
                    </Link>
                    ...
                    <div className={`${style.heightScroll} pt-3 `}>
                        ...
                        <li>
                            <Link
                                ...
                                className={classNames(location.pathname === `/Admin/appointments` ? 'text-black bg-gray-200' : 'text-white', " flex items-center p-2 text-base font-medium  rounded-lg transition duration-75 hover:bg-gray-100 hover:text-black group ")}
                        ...
                        <li>
                            <Link
                                to="/Admin/careers"
                                className={classNames(location.pathname === '/Admin/careers' ? 'text-black bg-gray-200' : 'text-white', " flex items-center p-2 text-base font-medium  rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-200 hover:text-black group ")}
