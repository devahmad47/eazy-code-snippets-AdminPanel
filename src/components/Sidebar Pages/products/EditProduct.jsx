...
const EditProduct = () => {
    ...
    useEffect(() => {
        const single = alldata.find(item => item._id === productId);
        setaddbook(single);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`${serverUrl}/api/product/${productId}/edit-product`, {
                            ...
                            <div className="border-l-2 border-gray-500 pl-8">
                                <div className="flex flex-col md:flex-row md:justify-between">
                                    <div className="mb-4 md:mb-0">
                                        <h3 className="text-xl font-bold mb-2">Update Image 1</h3>
                                    </div>
                                    <input
                                        type="file"
                                        accept="image/*"
                                ...
                                <div className="flex flex-col md:flex-row md:justify-between">
                                    <div className="mb-4 md:mb-0">
                                        <h3 className="text-xl font-bold mb-2">Update Image 2</h3>
                                    </div>
                                    <input
                                        type="file"
                                        accept="image/*"
                                ...
                                <div className="flex flex-col md:flex-row md:justify-between">
                                    <div className="mb-4 md:mb-0">
                                        <h3 className="text-xl font-bold mb-2">Update Image 3</h3>
                                    </div>
                                    <input
                                        type="file"
                                        accept="image/*"
                                ...
                                <div className="flex flex-col md:flex-row md:justify-between">
                                    <div className="mb-4 md:mb-0">
                                        <h3 className="text-xl font-bold mb-2">Update Image 4</h3>
                                    </div>
                                    <input
                                        type="file"
                                        accept="image/*"
                                ...
                                <div className="flex flex-col md:flex-row md:justify-between">
                                    <div className="mb-4 md:mb-0">
                                        <h3 className="text-xl font-bold mb-2">Update Image 5</h3>
                                    </div>
                                    <input
                                        type="file"
                                        accept="image/*"
